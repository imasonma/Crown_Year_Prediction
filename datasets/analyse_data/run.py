...
if __name__ == '__main__':
    ...
    base_dir = cfg.ENVIRONMENT.DATA_BASE_DIR + cfg.ENVIRONMENT.EXPERIMENT_NAME
    ...
    if cfg.ENVIRONMENT.DATA_BASE_DIR is not None:
        cfg.DATA_PREPARE.TRAIN_SERIES_IDS_TXT = cfg.ENVIRONMENT.CATCH_DIR + cfg.DATA_PREPARE.TRAIN_SERIES_IDS_TXT
        cfg.DATA_PREPARE.TEST_SERIES_IDS_TXT = cfg.ENVIRONMENT.CATCH_DIR + cfg.DATA_PREPARE.TEST_SERIES_IDS_TXT
